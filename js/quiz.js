(function(){
  ...
  app.controller('QuizController', ['$scope', '$http', '$sce', function($scope, $http, $sce){
    ...
    $http.get('quiz_data.json').then(function(quizData){ // get doesn't work in Chrome
    ...
    $scope.createShareLinks = function(percentage){
      ...
      var twitterLink = '<a class="btn twitter" target="_blank" href="http://twitter.com/share?text=I scored an '+percentage+'% on this quiz about Saturn. Try to beat my score at&hashtags=SaturnQuiz&url='+url+'">Tweet Your Score</a>';
